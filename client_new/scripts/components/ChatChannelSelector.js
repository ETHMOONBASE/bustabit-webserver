    ...
    return React.createClass({
        ...
        render: function() {
            ...
            var chans = ['arabic', 'armenian', 'basque', 'bengali', 'bosnian', 'bulgarian', 'chinese',
                ...
                'greek', 'hebrew', 'hindi', 'hungarian', 'indonesian', 'italian', 'korean', 'latvian', 'lithuanian', 
                'maltese', 'norwegian', 'polish', 'portuguese', 'romanian', 'russian', 'serbian', 'slovak', 'slovenian',
